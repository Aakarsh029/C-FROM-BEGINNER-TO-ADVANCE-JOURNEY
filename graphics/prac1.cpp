...
int main()
{
	...
	void drawingpad()
	{
		...
		while(1)
		{
			...
			//Color red
			else if(((GetKeyState(VK_LBUTTON) & 0x8000) != 0)&&cursorpos.x>18&&cursorpos.x<40&&cursorpos.y>228&&cursorpos.y<24)
			{
				colr=4;
				setcolor(8);
				outtextxy(13,598,(char*)"Marker     ");
			...
			//Color yellow
			else if(((GetKeyState(VK_LBUTTON) & 0x8000) != 0)&&cursorpos.x>44&&cursorpos.x<66&&cursorpos.y>228&&cursorpos.y<24)
			{
				colr=14;
				setcolor(8);
				outtextxy(13,598,(char*)"Marker     ");
			...
			//Clear all
			else if(((GetKeyState(VK_LBUTTON) & 0x8000) != 0)&&cursorpos.x>18&&cursorpos.x<66&&cursorpos.y>408&&cursorpos.y<45)
			{
				cleardevice();
				setup();
				setcolor(8);
			...
			//Brushsize
			else if(((GetKeyState(VK_LBUTTON) & 0x8000) != 0)&&cursorpos.x>18&&cursorpos.x<40&&cursorpos.y>484&&cursorpos.y<50)
			{
				radii=2;
				setcolor(8);
			...
			else if(((GetKeyState(VK_LBUTTON) & 0x8000) != 0)&&cursorpos.x>44&&cursorpos.x<66&&cursorpos.y>484&&cursorpos.y<50)
			{
				radii=6;
				setcolor(8);
				outtextxy(13,598,(char*)"Brush     ");
